...
# Generated for: Test Company Ltd
...
terraform {
  ...
  backend "azurerm" {
    ...
    key                  = "companies/test-company/terraform.tfstate"
  }
}
...
variable "api_container_image" {
  ...
  type        = string
  default     = "test-registry.azurecr.io/test/api:latest"
}

variable "web_container_image" {
  description = "Web container image"
  type        = string
  default     = "test-registry.azurecr.io/test/web:latest"
}
